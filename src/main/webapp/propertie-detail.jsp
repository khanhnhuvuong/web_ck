<%@ page import="vn.edu.hcmuaf.fit.model.Properties_detail" %>
<%@ page import="vn.edu.hcmuaf.fit.model.Propertie" %>
<%@ page import="java.util.List" %>
<%@ page import="vn.edu.hcmuaf.fit.sevice.PropertieService" %>
