                ...
                <div class="mySlider aa-top-slider-single ">
                    <a href="propertie-detail.jsp">
                        ...
                        <div class="aa-top-slider-content">
                            ...
                            <a href="propertie-detail.jsp" class="aa-top-slider-btn">Xem Thêm<span class="fa fa-angle-double-right"></span></a>
                        </div>
                    </a>
                    <!-- / Top slider content -->
                </div>
                            ...
                            <div class="col-md-2">
                                <div class="aa-single-advance-search">
                                    ...
                                    <option value="3">Phòng Gym</option>
                                        <option value="4"><label>Khu Picnic</label></option>
                                    <option value="5"><label>Công Viên</label></option>
                                  </select>
                                </div>
                            </div>
                            <div class="col-md-2">
        ...
        <div class="container">
            <div class="aa-latest-property-area">
              ...
              3 tỷ
                                    ...
                                    <a href="propertie-detail.jsp" class="aa-secondary-btn">Xem Chi Tiết</a>
                                </div>
                            </div>
                            <i class="fa-regular fa-heart btn" onclick="changeIcon(this)"></i>
                        </article>
                                ...
                                <div class="col-md-3">
                                    <div class="aa-single-service">
                                        ...
                                        <div class="aa-single-service-content">
                                            ...
                                            <p>Nơi chứa tất cả các dự án được quan tâm nhiều nhất hiện nay với mức giá vô cùng hợp lí và ưu đãi đối với mọi người.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="aa-single-service">
                                        ...
                                        <div class="aa-single-service-content">
                                            ...
                                            <p>Nơi giúp bạn nhanh chóng, thuận tiện và dễ dàng có thể sở hữu một căn hộ cho chính mình với mức chi phí ưu đãi hàng đầu hiện nay.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="aa-single-service">
                                        ...
                                        <div class="aa-single-service-content">
                                            ...
                                            <p>Luôn lấy những đánh giá và phản hồi của khách hàng làm động lực để có thể tiếp tục nâng cao và phát triển.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="aa-single-service">
                                        ...
                                        <div class="aa-single-service-content">
                                            ...
                                            <p>Với đội ngũ nhân viên đông đảo và kĩ năng chuyên môn cao sẵn sàng hỗ trợ khách hàng và tư vấn mọi nhu cầu, thắc mắc của khách hàng trong lĩnh vựng Bất Động Sản.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="aa-promo-banner-area">
                        ...
                        <p>Wealthuring sàn buôn bán bất động sản và căn hộ uy tính hàng đầu Việt Nam hiện nay, với các mức giá ưu đãi và dịch vụ chăm sóc khách hàng tốt nhất.</p>
                ...
                <div class="col-md-12">
                    <div class="aa-latest-blog-area">
                        <div class="aa-title">
                            ...
                            <span></span>
                            <p>Thông tin về các dự án Bất Động Sản mới nhất và các chia sẻ của các nhà đầu tư nổi tiếng trong lĩnh vực.</p>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <article class="aa-blog-single">
                                        ...
                                        <div class="aa-blog-single-content">
                                            <h3><a href="blog-detail-1.html">Sức hút của thị trường BĐS Duy Tiên và cơ hội cho giới địa ốc.</a></h3>
                                ...
                                <div class="col-md-4">
                                    <article class="aa-blog-single">
                                        ...
                                        <div class="aa-blog-single-content">
                                            <h3><a href="blog-detail-2.html">Tận hưởng “bữa tiệc thị giác” với tầm view triệu đô ngay tại trung tâm Hà Nội.</a></h3>
                                            <p>Khai Sơn City - dự án căn hộ mang phong cách hiện đại tại trung tâm Hà Nội đang được các nhà đầu tư săn đón khi mang đến cho tầng lớp tinh hoa tầm nhìn “triệu đô” đắt giá.</p>
                                            <div class="aa-blog-single-bottom">
                                                <a href="#" class="aa-blog-author"><i class="fa fa-user"></i> Admin</a>
                                                <a href="#" class="aa-blog-comments"><i class="fa fa-comment-o"></i>6</a>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <article class="aa-blog-single">
                                        ...
                                        <div class="aa-blog-single-content">
                                            <h3><a href="#">Thị trường bất động sản khan hiếm nguồn cung, đâu là tâm điểm ?</a></h3>
                                            <p>Nguồn cung hạn chế, lượng tiêu thụ không ngừng tăng khiến người mua nhà, giới đầu tư, kinh doanh bước vào “cuộc đua” săn tìm sản phẩm.</p>
                                            <div class="aa-blog-single-bottom">
                                                <a href="#" class="aa-blog-author"><i class="fa fa-user"></i> Admin</a>
                                                <a href="#" class="aa-blog-comments"><i class="fa fa-comment-o"></i>6</a>
                                            </div>
                            ...
                            <ul class="aa-testimonial-slider">
                                <li>
                                    <div class="aa-testimonial-single">
                                        ...
                                        <div class="aa-testimonial-info">
                                            <p>Một trang web rất uy tính và có đội ngũ nhân viên vô cùng thân thiện với tôi, họ giúp tôi có thể chọn lựa chỗ ở cho mình một cách rất tận tình và chu đáo. Mọi thứ đều mang lại cho tôi cảm giác rất hài lòng.</p>
                                        </div>
                                ...
                                <li>
                                    <div class="aa-testimonial-single">
                                        ...
                                        <div class="aa-testimonial-info">
                                            <p>Tại sao tôi lại không biết đến trang web này sớm hơn cơ chứ! Tất cả mọi thứ từ trang web đến đội ngũ nhân viên đều tạo cho tôi một cảm giác rất thân thiện. Điều đó càng làm tôi thấy hối hận vì không biết đến
                                ...
                                <li>
                                    <div class="aa-testimonial-single">
                                        ...
                                        <div class="aa-testimonial-info">
                                            <p>Cách họ giới thiệu và tư vấn cho tôi về các căn hộ của họ làm cho tôi rất hài lòng. Mọi người đều rất thân thiện và nhiệt tình với các khách hàng của mình chứ không chỉ riêng mình tôi.</p>
                                        </div>
                                        <div class="aa-testimonial-bio">
                                            <p>David Muller</p>
